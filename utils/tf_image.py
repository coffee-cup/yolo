...
from tensorflow.python.ops import (array_ops, check_ops, clip_ops,
                                   ...
                                   math_ops, random_ops, string_ops, variables)
...
# =========================================================================== #
def bboxes_crop_or_pad(bboxes, height, width, offset_y, offset_x,
    ...
    with tf.name_scope('bboxes_crop_or_pad'):
        ...
        # Add offset.
        offset = tf.cast(
            tf.stack([offset_y, offset_x, offset_y, offset_x]), bboxes.dtype)
...
def random_flip_left_right(image, bboxes, seed=None):
    ...
    with tf.name_scope('random_flip_left_right'):
        ...
        result = control_flow_ops.cond(
            ...
            lambda: image)
        # Flip bboxes.
        bboxes = control_flow_ops.cond(
            mirror_cond, lambda: flip_bboxes(bboxes), lambda: bboxes)
